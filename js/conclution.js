addMdToPage(`# Avslutande analys: Att förstå och förbättra studenters mentala hälsa
  Den samlade analysen av både indiska och globala dataset ger en tydlig bild av de faktorer som påverkar studenters depression. Några centrala mönster framträder:
  
  ### Kön och ålder
  - Kön visar små skillnader: både i Indien och globalt är andelen deprimerade bland män och kvinnor nästan lika.
  - Ålder är inte en avgörande faktor, även om yngre studenter (18–20 år) tenderar att rapportera något högre depressionsnivåer.
  ...
  Slutsats: Livsstilsfaktorer som sömn, kost och arbetsbelastning har en direkt påverkan på mental hälsa och bör adresseras parallellt med akademiska insatser.
  ...
  ### Global jämförelse
  - Trots kulturella skillnader är mönstren liknande i Indien och globalt: sömn, stress och livsstil är centrala, medan kön, ålder och CGPA spelar mindre roll.

  Slutsats: Förebyggande strategier kan vara universella, men bör anpassas till lokala kontexter och resurser.

  ### Rekommenderade åtgärder för att förbättra studenters mentala hälsa
  - Stressreducerande program
  - Workshops i tidshantering och akademisk planering.
  - Mentorskap och stödgrupper för att minska känslan av överbelastning.
  - Sömn- och livsstilsinterventioner
  - Utbildning i goda sömnvanor och kostvanor.
  - Flexibla scheman för att minska risk för överarbete.
  - Psykologiskt stöd och rådgivning
  - Tillgång till psykologer eller kuratorer på campus.
  - Digitala verktyg för stresshantering och mental hälsa.
  - Övervakning och tidig upptäckt
  - Regelbundna enkäter och screening av depression, särskilt vid hög akademisk press.
  ...
  Den centrala lärdomen: Det är inte betyg eller kön som bestämmer depression, det är stress och livsstil. 
  Att adressera dessa systematiskt kan göra verklig skillnad för studenters välmående.
`);
